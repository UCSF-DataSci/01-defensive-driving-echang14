...
def get_risk_level(bmi):
    ...
    # FIX: Changed 'risk_level' to 'risk_lvl' for consistency
    return risk_lvl
...
def analyze_patient_data(patients):
    ...
    results = []
    # BUG 3: Loop range off by one, missing last patient
    # FIX: Changed range to len(patients) to include all patients
...
def main():
    ...
    test_patients = [
        ("Patient A", 70, 175),   # Should be ~22.9 BMI (normal)
